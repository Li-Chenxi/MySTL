...
namespace stupid
{
	...
	public:
		...
		hash_set(size_type n, const hasher &h, const key_equal &e)
			:table(n, h, e)
		{
		}
		...
		template <typename InputIterator>
		hash_set(InputIterator first, InputIterator last, size_type n, const hasher &h)
			: table(n, h, key_equal())
		{
			table.insert_unique(first, last);
		}
		...
		template <typename InputIterator>
		hash_set(InputIterator first, InputIterator last, size_type n, const hasher &h, const key_equal &e)
			: table(n, h, e)
		{
			table.insert_unique(first, last);
		}
