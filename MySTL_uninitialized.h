...
namespace stupid
{
	...
	template <typename ForwardIterator, typename Type, typename Type1>
	inline ForwardIterator
		__uninitialized_fill(ForwardIterator first, ForwardIterator last, Type &x, Type1 *)
	{
		typedef typename __type_traits<Type1>::is_POD_type is_POD;
